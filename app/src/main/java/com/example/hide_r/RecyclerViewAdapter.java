...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RecyclerViewHolder> {
    ...
    private final ArrayList<String> mHiderPicsFolder;

    // on below line we have created a constructor.
    public RecyclerViewAdapter(Context context, ArrayList<String> mHiderPicsFolder) {
        this.context = context;
        this.mHiderPicsFolder = mHiderPicsFolder;
    }
        ...
        if (imgFile.exists()) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.putExtra("imgPath", mHiderPicsFolder.get(holder.getAdapterPosition()));
